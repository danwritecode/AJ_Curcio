<template>
  <div id="about" class="grid sm:grid-cols-2 gap-10 sm:gap-12 xl:gap-24">
    ...
    <div>
      <p class="text-3xl font-extrabold text-gray-900">What makes AJ an expert</p>
      ...
      <div class="mt-12 grid grid-cols-1 gap-y-12 gap-x-6 sm:grid-cols-2">
        <p>
          ...
          <span class="mt-1 block text-base text-gray-600">AJ sells <span class="font-medium text-gray-900">10x</span> more homes per year than the typical agent.</span>
        </p>
        <p>
