      ...
      <div v-if="currentStep === 'Quick Contact'" class="px-4 py-5 bg-white sm:p-6">
        <div class="grid grid-cols-6 gap-6">
          ...
          <div class="col-span-6 sm:col-span-3 flex flex-col-reverse">
            <input v-model="form.email" type="text" name="email-address" id="email" autocomplete="email" class="mt-1 focus:ring-red-500 focus:border-red-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md transition-hover-300">
